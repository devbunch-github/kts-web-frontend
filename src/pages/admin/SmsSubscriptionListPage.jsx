...
const SmsSubscriptionListPage = () => {
  const [entriesPerPage, setEntriesPerPage] = useState(10);
  const [search, setSearch] = useState("");

  // Temporary static data (replace later with API)
  const subscriptions = [
    {
      id: 1,
      name: "Octane",
    ...
    },
    {
      id: 3,
      name: "Siobhan",
      email: "info@siobhan.com",
      purchaseDate: "18-05-2025",
      nextPayment: "18-06-2025",
                ...
                <tbody>
                  {filteredData.map((row) => (
                    ...
                    >
                      ...
                      <td className="py-3 text-gray-700">{row.email}</td>
                      <td className="py-3 text-gray-700">{row.purchaseDate}</td>
                      <td className="py-3 text-gray-700">{row.nextPayment}</td>
                      <td className="py-3 text-gray-700">{row.expiryDate}</td>
                      <td className="py-3 text-gray-700">{row.store}</td>
                      <td className="py-3 text-gray-700">{row.usage}</td>
                      <td className="py-3">
...
export default SmsSubscriptionListPage;
