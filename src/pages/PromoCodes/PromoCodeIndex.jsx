  ...
  return (
    <span
      className={`inline-flex items-center px-2 py-1 text-xs rounded-full ${
        isActive ? "bg-[#E9F7EF] text-[#1E7E34]" : "bg-gray-100 text-gray-600"
      }`}
    >
      {label}
    </span>
...
export default function PromoCodeIndex() {
  ...
  const confirmDelete = async () => {
    ...
    setDeleting(true);
    try {
      await deletePromoCode(confirmId);
    ...
    <div className={`min-h-screen ${roseBg}`}>
      <div className="px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => navigate("/dashboard/promo-codes/new")}
              ...
              {loading ? (
                ...
                rows.map((r) => (
                  <tr key={r.id} className="hover:bg-rose-50/40 transition">
                    ...
                    <td className={cell}>{r.service}</td>
                    <td className={cell}>{r.discount_label}</td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4 text-sm">
                        <button
                          ...
                          onClick={() =>
                            navigate(`/dashboard/promo-codes/edit/${r.id}`)
                          }
                        >
